...
// LOCAL EDIT: upstream pins `0.8.21` for byte-reproducible deployments. This repo builds
// everything with 0.8.24, and no single version satisfies both that and FlippyGate's
// ^0.8.24, so the pin is widened. See README.md in this directory.
